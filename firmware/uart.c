...
File:     $Id: uart.c,v 1.5.2.9 2005/08/14 11:26:15 Peter Exp $
...
#error TX buffer size is not a power of 2
 ...
 #define UART0_DATA     UDR
 #define UART0_UDRIE    UDRIE
 /* AT Mega 644 added by Patrick Kaplan*/
...
void uart1_init(unsigned int baudrate)
{
    ...
    /* Set baud rate */
    if ( baudrate & 0x8000 ) UART1_STATUS = (1<<U2X1);  //Enable 2x speed 
    UBRR1H = ((unsigned char)(baudrate>>8))&0x80;
